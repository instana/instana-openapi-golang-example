...
*ApplicationAnalyzeApi* | [**GetProcessGroup**](docs/ApplicationAnalyzeApi.md#getprocessgroup) | **Post** /api/application-monitoring/analyze/process-groups | Get grouped profiled process metrics
*ApplicationAnalyzeApi* | [**GetProcesses**](docs/ApplicationAnalyzeApi.md#getprocesses) | **Post** /api/application-monitoring/analyze/processes | Get all profiled processes
*ApplicationAnalyzeApi* | [**GetProfiles**](docs/ApplicationAnalyzeApi.md#getprofiles) | **Post** /api/application-monitoring/analyze/profiles | Get profiles
...
## Documentation For Models
 ...
 - [GetProcessGroups](docs/GetProcessGroups.md)
 - [GetProcesses](docs/GetProcesses.md)
 - [GetProfiles](docs/GetProfiles.md)
 ...
 - [ProcessGroupsItem](docs/ProcessGroupsItem.md)
 - [ProcessGroupsResult](docs/ProcessGroupsResult.md)
 - [ProcessResult](docs/ProcessResult.md)
 - [ProcessesItem](docs/ProcessesItem.md)
 - [Profile](docs/Profile.md)
 - [ProfileNode](docs/ProfileNode.md)
 - [ProfilePath](docs/ProfilePath.md)
 - [ProfiledProcess](docs/ProfiledProcess.md)
 - [ProfilesItem](docs/ProfilesItem.md)
 ...
 - [WithLastUpdated](docs/WithLastUpdated.md)
