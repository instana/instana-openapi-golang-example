...
/*
APITokenApiService Delete API token
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param apiTokenId
*/
func (a *APITokenApiService) DeleteApiToken(ctx context.Context, apiTokenId string) (*http.Response, error) {
	var (
...
/*
APITokenApiService API token
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param apiTokenId
@return ApiToken
*/
func (a *APITokenApiService) GetApiToken(ctx context.Context, apiTokenId string) (ApiToken, *http.Response, error) {
	var (
...
/*
APITokenApiService All API tokes
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []ApiToken
*/
func (a *APITokenApiService) GetApiTokens(ctx context.Context) ([]ApiToken, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
APITokenApiService Create or update an API token
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param apiTokenId
 * @param apiToken
@return ApiToken
*/
func (a *APITokenApiService) PutApiToken(ctx context.Context, apiTokenId string, apiToken ApiToken) (ApiToken, *http.Response, error) {
	var (
