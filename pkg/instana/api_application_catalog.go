...
/*
ApplicationCatalogApiService Get Metric catalog
This endpoint retrieves all available metric definitions for application monitoring.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []MetricDescription
*/
func (a *ApplicationCatalogApiService) GetApplicationCatalogMetrics(ctx context.Context) ([]MetricDescription, *http.Response, error) {
	var (
...
/*
ApplicationCatalogApiService Get filter tag catalog
...
@return []PluginResult
*/
func (a *ApplicationCatalogApiService) GetApplicationCatalogTags(ctx context.Context) ([]PluginResult, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
