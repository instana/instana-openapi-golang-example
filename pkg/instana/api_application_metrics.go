...
/*
ApplicationMetricsApiService Get Application Metrics
...
func (a *ApplicationMetricsApiService) GetApplicationMetrics(ctx context.Context, localVarOptionals *GetApplicationMetricsOpts) (ApplicationMetricResult, *http.Response, error) {
	var (
...
/*
ApplicationMetricsApiService Get Endpoint metrics
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *ApplicationMetricsApiService) GetEndpointsMetrics(ctx context.Context, localVarOptionals *GetEndpointsMetricsOpts) (EndpointMetricResult, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
ApplicationMetricsApiService Get Service metrics
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *ApplicationMetricsApiService) GetServicesMetrics(ctx context.Context, localVarOptionals *GetServicesMetricsOpts) (ServiceMetricResult, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
