...
func (a *AuditLogApiService) GetAuditLogs(ctx context.Context, localVarOptionals *GetAuditLogsOpts) (AuditLogResponse, *http.Response, error) {
	var (
