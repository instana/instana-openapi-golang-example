 ...
 * @param websiteId
*/
func (a *DefaultApiService) CreateSourceMapConfig(ctx context.Context, websiteId string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/website-monitoring/config/{websiteId}/sourceMap"
 ...
 * @param id
*/
func (a *DefaultApiService) Delete(ctx context.Context, id string) (*http.Response, error) {
	var (
...
*/
func (a *DefaultApiService) DeleteSourceMapConfig(ctx context.Context, websiteId string, sourceMapConfigId string) (*http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/website-monitoring/config/{websiteId}/sourceMap/{sourceMapConfigId}"
	localVarPath = strings.Replace(localVarPath, "{"+"websiteId"+"}", fmt.Sprintf("%v", websiteId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"sourceMapConfigId"+"}", fmt.Sprintf("%v", sourceMapConfigId), -1)
 ...
 * @param id
*/
func (a *DefaultApiService) Disable(ctx context.Context, id string) (*http.Response, error) {
	var (
 ...
 * @param id
*/
func (a *DefaultApiService) Enable(ctx context.Context, id string) (*http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @param sourceMapConfigId
*/
func (a *DefaultApiService) GetSourceMapConfig(ctx context.Context, websiteId string, sourceMapConfigId string) (*http.Response, error) {
	var (
 ...
 * @param websiteId
*/
func (a *DefaultApiService) GetSourceMapConfigs(ctx context.Context, websiteId string) (*http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @param sourceMapConfigId
*/
func (a *DefaultApiService) UpdateSourceMapConfig(ctx context.Context, websiteId string, sourceMapConfigId string) (*http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
