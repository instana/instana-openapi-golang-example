...
@return EventResult
*/
func (a *EventsApiService) GetEvent(ctx context.Context, eventId string) (EventResult, *http.Response, error) {
	var (
...
func (a *EventsApiService) GetEvents(ctx context.Context, localVarOptionals *GetEventsOpts) ([]EventResult, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
