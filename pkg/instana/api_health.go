...
/*
HealthApiService Basic health traffic light
...
@return HealthState
*/
func (a *HealthApiService) GetHealthState(ctx context.Context) (HealthState, *http.Response, error) {
	var (
...
/*
HealthApiService API version information
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return InstanaVersionInfo
*/
func (a *HealthApiService) GetVersion(ctx context.Context) (InstanaVersionInfo, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
