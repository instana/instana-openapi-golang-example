...
/*
InfrastructureCatalogApiService Get metric catalog
...
func (a *InfrastructureCatalogApiService) GetInfrastructureCatalogMetrics(ctx context.Context, plugin string, localVarOptionals *GetInfrastructureCatalogMetricsOpts) ([]MetricInstance, *http.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"plugin"+"}", fmt.Sprintf("%v", plugin), -1)
...
/*
InfrastructureCatalogApiService Get plugin catalog
This endpoint retrieves all available plugin ids for your monitored system.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []PluginResult
*/
func (a *InfrastructureCatalogApiService) GetInfrastructureCatalogPlugins(ctx context.Context) ([]PluginResult, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
InfrastructureCatalogApiService get search field catalog
...
*/
func (a *InfrastructureCatalogApiService) GetInfrastructureCatalogSearchFields(ctx context.Context) ([]SearchFieldResult, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
