...
/*
InfrastructureMetricsApiService Get infrastructure metrics
...
func (a *InfrastructureMetricsApiService) GetInfrastructureMetrics(ctx context.Context, localVarOptionals *GetInfrastructureMetricsOpts) (InfrastructureMetricResult, *http.Response, error) {
	var (
...
/*
InfrastructureMetricsApiService Get snapshot details
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
...
func (a *InfrastructureMetricsApiService) GetSnapshot(ctx context.Context, id string, localVarOptionals *GetSnapshotOpts) (SnapshotItem, *http.Response, error) {
	var (
...
/*
InfrastructureMetricsApiService Search snapshots
...
func (a *InfrastructureMetricsApiService) GetSnapshots(ctx context.Context, localVarOptionals *GetSnapshotsOpts) (SnapshotResult, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
