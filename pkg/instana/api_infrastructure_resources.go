...
/*
InfrastructureResourcesApiService Get view tree
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return TreeNodeResult
*/
func (a *InfrastructureResourcesApiService) GetInfrastructureViewTree(ctx context.Context) (TreeNodeResult, *http.Response, error) {
	var (
...
/*
InfrastructureResourcesApiService Monitored host count
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return MonitoringState
*/
func (a *InfrastructureResourcesApiService) GetMonitoringState(ctx context.Context) (MonitoringState, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
InfrastructureResourcesApiService Related hosts
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param snapshotId
@return []string
*/
func (a *InfrastructureResourcesApiService) GetRelatedHosts(ctx context.Context, snapshotId string) ([]string, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
InfrastructureResourcesApiService Get installed software
...
func (a *InfrastructureResourcesApiService) SoftwareVersions(ctx context.Context, localVarOptionals *SoftwareVersionsOpts) ([]SoftwareVersion, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
