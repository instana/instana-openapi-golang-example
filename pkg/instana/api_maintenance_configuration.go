...
/*
MaintenanceConfigurationApiService Delete maintenance configuration
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
*/
func (a *MaintenanceConfigurationApiService) DeleteMaintenanceConfig(ctx context.Context, id string) (*http.Response, error) {
	var (
...
/*
MaintenanceConfigurationApiService Maintenance configuration
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
@return WithLastUpdated
*/
func (a *MaintenanceConfigurationApiService) GetMaintenanceConfig(ctx context.Context, id string) (WithLastUpdated, *http.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  WithLastUpdated
	)
...
/*
MaintenanceConfigurationApiService All maintenance configurations
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []ValidatedMaintenanceConfigWithStatus
*/
func (a *MaintenanceConfigurationApiService) GetMaintenanceConfigs(ctx context.Context) ([]ValidatedMaintenanceConfigWithStatus, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
MaintenanceConfigurationApiService Create or update maintenance configuration
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param maintenanceConfig
*/
func (a *MaintenanceConfigurationApiService) PutMaintenanceConfig(ctx context.Context, id string, maintenanceConfig MaintenanceConfig) (*http.Response, error) {
	var (
...
/*
MaintenanceConfigurationApiService Schedule maintenance
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
*/
func (a *MaintenanceConfigurationApiService) ScheduleMaintenanceConfig(ctx context.Context, id string) (*http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/settings/maintenance/schedule/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
MaintenanceConfigurationApiService Unschedule maintenance
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
*/
func (a *MaintenanceConfigurationApiService) UnscheduleMaintenanceConfig(ctx context.Context, id string) (*http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/settings/maintenance/unschedule/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
