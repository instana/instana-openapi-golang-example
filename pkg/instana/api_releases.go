...
func (a *ReleasesApiService) GetAllReleases(ctx context.Context, localVarOptionals *GetAllReleasesOpts) ([]WithMetadata, *http.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  []WithMetadata
	)
...
@return WithMetadata
*/
func (a *ReleasesApiService) GetRelease(ctx context.Context, releaseId string) (WithMetadata, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return WithMetadata
*/
func (a *ReleasesApiService) PostRelease(ctx context.Context, release Release) (WithMetadata, *http.Response, error) {
	var (
...
@return WithMetadata
*/
func (a *ReleasesApiService) PutRelease(ctx context.Context, releaseId string, release Release) (WithMetadata, *http.Response, error) {
	var (
