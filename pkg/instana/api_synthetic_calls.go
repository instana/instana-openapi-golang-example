...
/*
SyntheticCallsApiService Delete synthetic call configurations
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
*/
func (a *SyntheticCallsApiService) DeleteSyntheticCall(ctx context.Context) (*http.Response, error) {
	var (
...
/*
SyntheticCallsApiService Synthetic call configurations
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return SyntheticCallWithDefaultsConfig
*/
func (a *SyntheticCallsApiService) GetSyntheticCalls(ctx context.Context) (SyntheticCallWithDefaultsConfig, *http.Response, error) {
	var (
...
/*
SyntheticCallsApiService Update synthetic call configurations
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param syntheticCallConfig
*/
func (a *SyntheticCallsApiService) UpdateSyntheticCall(ctx context.Context, syntheticCallConfig SyntheticCallConfig) (*http.Response, error) {
	var (
