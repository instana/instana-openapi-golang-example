...
/*
UsageApiService API usage by customer
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []UsageResult
*/
func (a *UsageApiService) GetAllUsage(ctx context.Context) ([]UsageResult, *http.Response, error) {
	var (
...
/*
UsageApiService Host count day / month / year
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param day
 * @param month
 * @param year
@return []UsageResult
*/
func (a *UsageApiService) GetHostsPerDay(ctx context.Context, day int32, month int32, year int32) ([]UsageResult, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
UsageApiService Host count month / year
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param month
 * @param year
@return []UsageResult
*/
func (a *UsageApiService) GetHostsPerMonth(ctx context.Context, month int32, year int32) ([]UsageResult, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
UsageApiService API usage day / month / year
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param day
 * @param month
 * @param year
@return []UsageResult
*/
func (a *UsageApiService) GetUsagePerDay(ctx context.Context, day int32, month int32, year int32) ([]UsageResult, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
UsageApiService API usage month / year
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param month
 * @param year
@return []UsageResult
*/
func (a *UsageApiService) GetUsagePerMonth(ctx context.Context, month int32, year int32) ([]UsageResult, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
