...
/*
UserApiService Delete role
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param roleId
*/
func (a *UserApiService) DeleteRole(ctx context.Context, roleId string) (*http.Response, error) {
	var (
...
/*
UserApiService All pending invitations
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []UserResult
*/
func (a *UserApiService) GetInvitations(ctx context.Context) ([]UserResult, *http.Response, error) {
	var (
...
@return Role
*/
func (a *UserApiService) GetRole(ctx context.Context, roleId string) (Role, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
UserApiService All roles
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []Role
*/
func (a *UserApiService) GetRoles(ctx context.Context) ([]Role, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
UserApiService All tenant users (excluding pending invitations)
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []UserResult
*/
func (a *UserApiService) GetUsers(ctx context.Context) ([]UserResult, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
UserApiService All users (incl. invitations)
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return UsersResult
*/
func (a *UserApiService) GetUsersIncludingInvitations(ctx context.Context) (UsersResult, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
UserApiService Create or update role
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param roleId
 * @param role
@return Role
*/
func (a *UserApiService) PutRole(ctx context.Context, roleId string, role Role) (Role, *http.Response, error) {
	var (
...
/*
UserApiService Remove user from tenant
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId
*/
func (a *UserApiService) RemoveUserFromTenant(ctx context.Context, userId string) (*http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
UserApiService Revoke pending invitation
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *UserApiService) RevokePendingInvitations(ctx context.Context, localVarOptionals *RevokePendingInvitationsOpts) (*http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
UserApiService Send user invitation
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *UserApiService) SendInvitation(ctx context.Context, localVarOptionals *SendInvitationOpts) (*http.Response, error) {
	var (
...
/*
UserApiService Add user to role
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId
...
func (a *UserApiService) SetRole(ctx context.Context, userId string, localVarOptionals *SetRoleOpts) (*http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
