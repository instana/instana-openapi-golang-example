...
/*
WebsiteAnalyzeApiService Get grouped beacon metrics
...
func (a *WebsiteAnalyzeApiService) GetBeaconGroups(ctx context.Context, localVarOptionals *GetBeaconGroupsOpts) (BeaconGroupsResult, *http.Response, error) {
	var (
...
/*
WebsiteAnalyzeApiService Get all beacons
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *WebsiteAnalyzeApiService) GetBeacons(ctx context.Context, localVarOptionals *GetBeaconsOpts) (BeaconResult, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
