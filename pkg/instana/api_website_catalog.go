...
/*
WebsiteCatalogApiService Metric catalog
...
*/
func (a *WebsiteCatalogApiService) GetWebsiteCatalogMetrics(ctx context.Context) ([]WebsiteMonitoringMetricDescription, *http.Response, error) {
	var (
...
/*
WebsiteCatalogApiService Filter tag catalog
...
*/
func (a *WebsiteCatalogApiService) GetWebsiteCatalogTags(ctx context.Context) ([]MetricInstance, *http.Response, error) {
	var (
		localVarHttpMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
