...
/*
WebsiteConfigurationApiService Remove website
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param websiteId
*/
func (a *WebsiteConfigurationApiService) Delete1(ctx context.Context, websiteId string) (*http.Response, error) {
	var (
...
/*
WebsiteConfigurationApiService Get configured websites
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []Website
*/
func (a *WebsiteConfigurationApiService) Get(ctx context.Context) ([]Website, *http.Response, error) {
	var (
...
/*
WebsiteConfigurationApiService Configure new website
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *WebsiteConfigurationApiService) Post(ctx context.Context, localVarOptionals *PostOpts) (Website, *http.Response, error) {
	var (
...
/*
WebsiteConfigurationApiService Rename website
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param websiteId
...
func (a *WebsiteConfigurationApiService) Rename(ctx context.Context, websiteId string, localVarOptionals *RenameOpts) (Website, *http.Response, error) {
	var (
