...
/*
WebsiteMetricsApiService Get beacon metrics
...
func (a *WebsiteMetricsApiService) GetBeaconMetrics(ctx context.Context, localVarOptionals *GetBeaconMetricsOpts) (WebsiteMetricResult, *http.Response, error) {
	var (
...
/*
WebsiteMetricsApiService Get page load
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param timestamp
@return []WebsiteMonitoringBeacon
*/
func (a *WebsiteMetricsApiService) GetPageLoad(ctx context.Context, id string, timestamp int64) ([]WebsiteMonitoringBeacon, *http.Response, error) {
	var (
